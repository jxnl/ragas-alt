...
async def test_high_relevance():
    ...
    relevance_result = await AnswerRelevance.grade(
        question=question,
        answer=answer,
...
async def test_mixed_relevance():
...
async def main():
    ...
    await test_high_relevance()
    await test_mixed_relevance()
    await test_low_relevance() 
